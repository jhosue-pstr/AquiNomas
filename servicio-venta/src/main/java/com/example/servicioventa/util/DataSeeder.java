...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        // ⚡ Verificar si hay datos antes de insertar
    ...
    private void seedVentas() {
        ...
        ventaRepository.saveAll(List.of(venta1, venta2));
        System.out.println("✅ Seeded Ventas");
    }

    private void seedVentaDetalles() {
        Detalle_Venta detalle1 = new Detalle_Venta(null, 1, 101, 2, new BigDecimal("50.00"), new BigDecimal("100.00"));
        Detalle_Venta detalle2 = new Detalle_Venta(null, 2, 102, 3, new BigDecimal("70.00"), new BigDecimal("210.00"));
